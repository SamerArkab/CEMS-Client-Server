...
public class OnlineExamination2Boundary {
	...
	/**
	 * initialize GUI with full online exam questions, possible answers and choice
	 * combo-box
	 */
	@FXML
	...
	/**
	 * if user did not finish in time, exam is automatically being submitted. back
	 * button now can be pressed to return to main window
	 */
	@SuppressWarnings("unchecked")
